...
#################################################
# Streamlit ile kullanıcı etkileşimi (button, radio, checkbox, slider, number input, file uploader)
#################################################
...
#################################################
# Streamlit ile ara yüz yerleşimi (col, tab, sidebar)
#################################################
...
#################################################
# Streamlit bileşenleriyle program akışı
#################################################
